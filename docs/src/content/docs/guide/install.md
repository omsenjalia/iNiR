...
**NixOS:** there is an experimental flake path. See [NixOS](/guide/nixos/).
:::
...
For everything else, check [PACKAGES.md](/reference/packages/). It's organized by category so you can skip what you don't need.
...
- [KEYBINDS.md](/reference/keybinds/) - Learn the shortcuts
- [IPC.md](/reference/ipc/) - Make your own keybindings
- [SETUP.md](/guide/setup/) - Updating, uninstalling, how configs are handled
- [PACKAGES.md](/reference/packages/) - Full package list if something's missing
