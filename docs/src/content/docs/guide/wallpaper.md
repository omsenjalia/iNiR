...
44 built-in presets bypass the wallpaper color pipeline entirely and inject predefined color palettes. See [Theming Presets](/architecture-theming/theming-presets/).
