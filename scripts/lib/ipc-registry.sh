...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["brightness:sleepBegin"]="Ignore screen hotplug while monitors are powered off"
  ["brightness:restoreAfterWake"]="Re-read hardware after DPMS and restore last-good if the read is zero"
...
IPC_II_TARGETS=()
IPC_WAFFLE_TARGETS=(autostart customWidgets osd powerProfile recordingOsd search taskview wactionCenter waffleAltSwitcher wbar widgetpower wnotificationCenter wwidgets)
